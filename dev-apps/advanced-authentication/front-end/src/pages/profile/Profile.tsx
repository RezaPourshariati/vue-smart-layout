...
import { getUser, selectUser, updateUser } from '@/redux/features/auth/authSlice.ts'

const cloudName = import.meta.env.VITE_CLOUD_NAME
const uploadPreset = import.meta.env.VITE_UPLOAD_PRESET

export function shortenText(text: string, n: number): string {
  if (text.length > n)
  ...
  return (
    <>
      <p
        ...
        style={{ borderRight: '2px solid greenYellow', paddingRight: '2rem' }}
      >
        Hi,
        {' '}
        {shortenText(userName, 14)}
      </p>
    </>
  )
}
